...
///
/// Shielded pool fields (`sapling_zat`, `orchard_zat`) report the spendable value reported
/// by the underlying wallet summary: notes whose witnesses are computable and whose
...
impl AccountBalance {
    /// Returns the spending-pool view: Sapling plus Orchard spendable.
    #[must_use]
    pub const fn shielded_zat(&self) -> Zatoshis {
        self.sapling_zat.saturating_add(self.orchard_zat)
    }
